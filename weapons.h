...
class Weapons final : public BaseEvents
{
	public:
		...
		static int32_t getMaxMeleeDamage(int32_t attackSkill, int32_t attackValue, int32_t strength = 0, int32_t dexterity = 0);
		static int32_t getMaxWeaponDamage(uint32_t level, int32_t attackSkill, int32_t attackValue, float attackFactor, int32_t strength = 0, int32_t dexterity = 0);
